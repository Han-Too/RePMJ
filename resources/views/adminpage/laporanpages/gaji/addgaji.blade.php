...
@section('headjudul', 'Buat Laporan Gaji Karyawan')
                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Buat Laporan Gaji Karyawan</span>
                        ...
                        <div class="card-body pt-3">
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                <!--begin::Form-->
                                <form id="" class="form" action='/gaji/cetak' method='post'
                                    ...
                                    <div class="card-body border-top p-9">
                                        ...
                                        placeholder="Isikan Pekerjaan" value="{{ $karyawan->id }}" />
                                        <!--begin::Input group-->
                                        <div class="row mb-6">
                                            <!--begin::Label-->
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input type="number" name="kasbon"
                                                    class="form-control form-control-lg form-control-solid"
                                                    placeholder="Isikan Kasbon" value="" required />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="container1">
                                            ...
                                            @for ($i = 1; $i <= $kolom; $i++)
                                                <div class="row mb-6">
                                                    ...
                                                    <!--begin::Col-->
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="text" name="kerjaan[{{ $i }}]"
                                                            class="form-control form-control-lg form-control-solid"
                                                            placeholder="Isikan Pekerjaan" value="" />
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                <div class="row mb-6">
                                                    ...
                                                    <!--begin::Col-->
                                                    <div class="col-lg-8 fv-row">
                                                        <input type="number" name="pendapatan[{{ $i }}]"
                                                            name="harga"
                                                            class="form-control form-control-lg form-control-solid"
