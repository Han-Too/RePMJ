                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Laporan Pekerjaan</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">Tambah atau Edit Laporan Pekerjaan</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                                ...
                                <table class='table table-bordered table-condensed table-striped table-hover'>
                                    ...
                                    <thead class="fw-bold bg-success">
                                        <tr style="line-height: 40px">
                                            <th class="p-0 min-w-150px text-center">Nama Produk</th>
                                            <th class="p-0 text-center">Jenis Material</th>
                                        </tr>
                                    </thead>
                                    <!--end::Table head-->
                                    <!--begin::Table body-->
