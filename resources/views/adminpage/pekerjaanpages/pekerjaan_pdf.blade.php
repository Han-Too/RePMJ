        ...
        <table class="table table-bordered border-dark mt-xl-5" nobr="true">
            <thead>
                <tr class="fw-bold fs-10" style="vertical-align: middle; height: 80px">
                    ...
                    <th class="p-0 min-w-200px text-center">Keterangan</th>
                </tr>
            </thead>
            <tbody nobr="true">
                @for ($i = 0; $i < $hitung; $i++)
                    <tr style="vertical-align: middle;" nobr="true">
                        ...
                        <td class="text-center">{{ $luas[$i] }}</td>
                        <td class="text-center">Rp. {{ number_format($harga[$i]) }}</td>
                        <td class="text-center">Rp. {{ number_format($luas[$i] * $harga[$i]) }}</td>
