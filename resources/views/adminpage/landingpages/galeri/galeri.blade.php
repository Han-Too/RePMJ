                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex flex-row justify-content-center">
                                                        <div class="p-2"><a href="/admin/galeri/{{ $galeri->id }}/edit"
                                                            class="btn btn-success btn-lg">Edit</a></div>
                                                        <div class="p-2"><a onclick="deleteConfirmation({{ $galeri->id }})"
                                                    ...
                                                    <button onclick="deleteConfirmation({{$galeri->id}})" id="delete-canopy"
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'Data Galeri has been deleted !'
                            });
                        }
                    });
