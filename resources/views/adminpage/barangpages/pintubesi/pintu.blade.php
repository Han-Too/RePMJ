                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">List Produk Pintu Besi</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">Tambah atau Edit Data Pintu Besi</span>
                            </h3>
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <!--begin::Menu-->
                                <a href="/admin/pintubesi/create"
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class='table table-bordered table-condensed table-striped table-hover'>
                                    ...
                                    <!--begin::Table body-->
                                    <tbody>
                                        @forelse ($postpintu as $key => $postpintubesi)
                                            <tr>
                                                <td class="text-start">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-45px me-5">
                                                            <img alt="Pic"
                                                                src="{{ asset('Images/uploads/pintubesi') }}/{{ $postpintubesi->foto }}" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                                ...
                                                <td class="text-start">
                                                    <span class="text-dark fw-bold  d-block mb-1 fs-6">
                                                        Rp. {{ $postpintubesi->harga }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    @if ($postpintubesi->status == 'tersedia')
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="/admin/pintubesi/{{ $postpintubesi->id }}/edit"
                                                        class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1">
                                                    ...
                                                    <button onclick="deleteConfirmation({{$postpintubesi->id}})" id="delete-canopy"
        ...
        function deleteConfirmation(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: `{{ url('/admin/pintubesi/${id}/destroy') }}`,
