                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <!--begin::Add product-->
                                <a href="{{ route('admin.pintubesi.create') }}" class="btn btn-success">Tambah Produk</a>
                                <!--end::Add product-->
                            </div>
                            <!--end::Toolbar-->
                        </div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="symbol symbol-100px">
                                                            <span class="symbol-label"
                                                                style="background-image:url({{ asset('Images/uploads/pintubesi') }}/{{ $pintu->foto }});"></span>
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                        <div class="ms-5">
                                                            <!--begin::Title-->
                                                            <a href="/admin/pintubesi/{{ $pintu->id }}/edit"
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'Pintu Besi has been deleted !'
                            });
                        }
                    });
