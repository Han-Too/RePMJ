...
@section('headjudul', 'Tambah Pintu Besi')
                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Tambah Produk Pintu Besi</span>
                        ...
                        <div class="card-body pt-3">
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                <!--begin::Form-->
                                <form id="" class="form" action='/admin/pintubesi/store' method='post'
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="jenis_produk"
                                                    class="form-control form-control-lg form-control-solid"
                                                    placeholder="Isikan Jenis Produk" value="Pintu Besi" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
