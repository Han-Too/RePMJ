                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Menu-->
                                <a href="/admin/tanggabesi/create"
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class='table table-bordered table-condensed table-striped table-hover'>
                                    ...
                                    <!--begin::Table body-->
                                    <tbody>
                                        @forelse ($posttanggabesi as $key => $posttanggabesi)
                                            <tr>
                                                <td class="text-start">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-45px me-5">
                                                            <img alt="Pic"
                                                                src="{{ asset('Images/uploads/tanggabesi') }}/{{ $posttanggabesi->foto }}" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <span  class="text-dark fw-bold  mb-1 fs-6">
                                                                {{ $posttanggabesi->judul }}
                                                            </span>
                                                            <span class="text-muted  fw-semibold text-muted d-block fs-7">
                                                                <span class="text-dark">Kode</span>:
                                                                {{ $posttanggabesi->id }}</span>
                                                        </div>
                                                        <!--end::Name-->
                                                    </div>
                                                </td>
                                                <td class="text-start">
                                                    <span class="text-dark fw-bold  d-block mb-1 fs-6">
                                                        {{ $posttanggabesi->bahan }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    <span class="text-dark fw-bold  d-block mb-1 fs-6">
                                                        Rp. {{ $posttanggabesi->harga }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    @if ($posttanggabesi->status == 'tersedia')
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="/admin/tanggabesi/{{ $posttanggabesi->id }}/edit"
                                                        class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1">
                                                    ...
                                                    <button onclick="deleteConfirmation({{$posttanggabesi->id}})" id="delete-canopy"
