...
@section('headjudul', 'Tangga Putar')
                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">List Produk Tangga Putar</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">Tambah atau Edit Data Tangga Putar</span>
                            </h3>
                            <!--begin::Toolbar-->
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <!--begin::Add product-->
                                <a href="{{ route('admin.tanggaputar.create') }}" class="btn btn-success">Tambah Produk</a>
                                <!--end::Add product-->
                            </div>
                            <!--end::Toolbar-->
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-data align-middle table-row-dashed table-data fs-6 gy-5">
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        @forelse ($posttanggaputar as $key => $tanggaputar)
                                            <!--begin::Table row-->
                                            <tr>
                                                <!--begin::Category=-->
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="symbol symbol-100px">
                                                            <span class="symbol-label"
                                                                style="background-image:url({{ asset('Images/uploads/tanggaputar') }}/{{ $tanggaputar->foto }});"></span>
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                        <div class="ms-5">
                                                            <!--begin::Title-->
                                                            <a href="/admin/tanggaputar/{{ $tanggaputar->id }}/edit"
                                                                class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                                data-kt-ecommerce-product-filter="product_name">{{ $tanggaputar->judul }}</a>
                                                            <!--end::Title-->
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center pe-0">
                                                    <span class="fw-bold ms-3">{{ $tanggaputar->id }}</span>
                                                </td>
                                                <!--begin::SKU=-->
                                                <td class="text-center pe-0">
                                                    <span class="fw-bold">{{ $tanggaputar->bahan }}</span>
                                                </td>
                                                <!--end::SKU=-->
                                                <!--begin::Price=-->
                                                <td class="text-center pe-0">
                                                    <span class="fw-bold text-dark">Rp. {{ $tanggaputar->harga }}</span>
                                                </td>
                                                <!--end::Price=-->
                                                <!--begin::Status=-->
                                                <td class="text-center pe-0" data-order="Published">
                                                    <!--begin::Badges-->
                                                    @if ($tanggaputar->status == 'tersedia')
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex flex-row justify-content-end">
                                                        <div class="p-2"><a href="/admin/tanggaputar/{{ $tanggaputar->id }}/edit"
                                                            class="btn btn-success btn-lg">Edit</a></div>
                                                        <div class="p-2"><a onclick="deleteConfirmation({{ $tanggaputar->id }})"
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a onclick="deleteConfirmation({{ $tanggaputar->id }})"
        ...
        function deleteConfirmation(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: `{{ url('/admin/tanggaputar/${id}/destroy') }}`,
                        success: function(data) {
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'Tangga Putar has been deleted !'
                            });
                        }
                    });
