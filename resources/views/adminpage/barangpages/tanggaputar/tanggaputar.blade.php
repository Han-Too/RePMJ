                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Menu-->
                                <a href="/admin/tanggaputar/create"
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class='table table-bordered table-condensed table-striped table-hover'>
                                    ...
                                    <!--begin::Table body-->
                                    <tbody>
                                        @forelse ($posttanggaputar as $key => $posttanggaputar)
                                            <tr>
                                                <td class="text-start">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-45px me-5">
                                                            <img alt="Pic"
                                                                src="{{ asset('Images/uploads/tanggaputar') }}/{{ $posttanggaputar->foto }}" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <span  class="text-dark fw-bold  mb-1 fs-6">
                                                                {{ $posttanggaputar->judul }}
                                                            </span>
                                                            <span class="text-muted  fw-semibold text-muted d-block fs-7">
                                                                <span class="text-dark">Kode</span>:
                                                                {{ $posttanggaputar->id }}</span>
                                                        </div>
                                                        <!--end::Name-->
                                                    </div>
                                                </td>
                                                <td class="text-start">
                                                    <span class="text-dark fw-bold  d-block mb-1 fs-6">
                                                        {{ $posttanggaputar->bahan }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    <span class="text-dark fw-bold  d-block mb-1 fs-6">
                                                        Rp. {{ $posttanggaputar->harga }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    @if ($posttanggaputar->status == 'tersedia')
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="/admin/tanggaputar/{{ $posttanggaputar->id }}/edit"
                                                        class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1">
                                                    ...
                                                    <button onclick="deleteConfirmation({{$posttanggaputar->id}})" id="delete-canopy"
