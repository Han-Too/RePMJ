                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Detail Produk Teralis Pintu</span>
                        ...
                        <div class="card-body pt-3">
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                <!--begin::Form-->
                                <form id="" class="form" action='/admin/teralispintu/{{$teralispintu->id}}/update' method='post'
                                    ...
                                    <div class="card-body border-top p-9">
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                                                    ...
                                                    <div class="image-input-wrapper w-300px h-300px" style="background-image: url({{ asset('Images/uploads/teralispintu') }}/{{ $teralispintu->foto }})"></div>
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="judul"
                                                    ...
                                                    placeholder="Isikan Produk" value="{{old('judul', $teralispintu->judul)}}" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input type="tel" name="harga" onKeyUp="rupiahrp(this)" onKeyPress="return isNumber(event)"
                                                    class="form-control form-control-lg form-control-solid"
                                                    placeholder="Isikan Harga" value="{{old('harga', $teralispintu->harga)}}"  id="inputBiayaDonasi" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="bahan"
                                                    class="form-control form-control-lg form-control-solid"
                                                    placeholder="Isikan Jenis Material" value="{{old('bahan', $teralispintu->bahan)}}" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="jenis_produk"
                                                    class="form-control form-control-lg form-control-solid"
                                                    placeholder="Isikan Jenis Produk" value="{{old('jenis_produk', $teralispintu->jenis_produk)}}" />
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                ...
                                                >{{old('deskripsi', $teralispintu->deskripsi)}}</textarea>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                ...
                                                <select name="status" aria-label="Status" data-control="select2"
                                                    ...
                                                    <?php if($teralispintu->status == "tersedia")echo "selected" ?>
                                                    >Tersedia</option>
                                                    <option value="tidaktersedia"
                                                    <?php if($teralispintu->status == "tidaktersedia")echo "selected" ?>
