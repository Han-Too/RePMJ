                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <!--begin::Add product-->
                                <a href="{{ route('admin.pintukasanyamuk.create') }}" class="btn btn-success">Tambah Produk</a>
                                <!--end::Add product-->
                            </div>
                            <!--end::Toolbar-->
                        </div>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="symbol symbol-100px">
                                                            <span class="symbol-label"
                                                                style="background-image:url({{ asset('Images/uploads/pintukasa') }}/{{ $pintu->foto }});"></span>
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                        <div class="ms-5">
                                                            <!--begin::Title-->
                                                            <a href="/admin/pintukasanyamuk/{{ $pintu->id }}/edit"
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex flex-row justify-content-end">
                                                        <div class="p-2"><a href="/admin/pintukasanyamuk/{{ $pintu->id }}/edit"
        ...
        function deleteConfirmation(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: `{{ url('/admin/pintukasanyamuk/${id}/destroy') }}`,
                        success: function(data) {
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'Pintu kasa nyamuk has been deleted !'
                            });
                        }
                    });
