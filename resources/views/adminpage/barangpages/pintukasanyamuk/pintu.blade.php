...
@section('headjudul', 'Pintu Kasa Nyamuk')
                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">List Produk Pintu Kasa Nyamuk</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">Tambah atau Edit Data Pagar</span>
                            </h3>
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <!--begin::Menu-->
                                <a href="/admin/pintukasanyamuk/create"
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class='table table-bordered table-condensed table-striped table-hover'>
                                    ...
                                    <!--begin::Table body-->
                                    <tbody>
                                        @forelse ($postpintu as $key => $postpintukasanyamuk)
                                            <tr>
                                                <td class="text-start">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-45px me-5">
                                                            <img alt="Pic"
                                                                src="{{ asset('Images/uploads/pintukasa') }}/{{ $postpintukasanyamuk->foto }}" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <span  class="text-dark fw-bold  mb-1 fs-6">
                                                                {{ $postpintukasanyamuk->judul }}
                                                            </span>
                                                            <span class="text-muted  fw-semibold text-muted d-block fs-7">
                                                                <span class="text-dark">Kode</span>:
                                                                {{ $postpintukasanyamuk->id }}</span>
                                                        </div>
                                                        <!--end::Name-->
                                                    </div>
                                                </td>
                                                <td class="text-start">
                                                    <span class="text-dark fw-bold  d-block mb-1 fs-6">
                                                        {{ $postpintukasanyamuk->bahan }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    <span class="text-dark fw-bold  d-block mb-1 fs-6">
                                                        Rp. {{ $postpintukasanyamuk->harga }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    @if ($postpintukasanyamuk->status == 'tersedia')
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="/admin/pintubesi/{{ $postpintukasanyamuk->id }}/edit"
                                                        class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1">
                                                    ...
                                                    <button onclick="deleteConfirmation({{$postpintukasanyamuk->id}})" id="delete-canopy"
