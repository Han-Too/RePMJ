                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class='table table-bordered table-condensed table-striped table-hover'>
                                    ...
                                    <!--begin::Table body-->
                                    <tbody>
                                        @forelse ($postmenaraair as $key => $postmenaraair)
                                            <tr>
                                                <td class="text-start">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-45px me-5">
                                                            <img alt="Pic"
                                                                src="{{ asset('Images/uploads/menaraair') }}/{{ $postmenaraair->foto }}" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                                ...
                                                <td class="text-start">
                                                    <span class="text-dark fw-bold  d-block mb-1 fs-6">
                                                        Rp. {{ $postmenaraair->harga }}
                                                    </span>
                                                </td>
                                                <td class="text-start">
                                                    @if ($postmenaraair->status == 'tersedia')
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="/admin/menaraair/{{ $postmenaraair->id }}/edit"
                                                        class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1">
                                                    ...
                                                    <button onclick="deleteConfirmation({{$postmenaraair->id}})" id="delete-canopy"
