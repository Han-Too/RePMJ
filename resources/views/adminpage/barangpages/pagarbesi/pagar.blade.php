                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <!--begin::Add product-->
                                <a href="{{ route('admin.pagar.create') }}" class="btn btn-success">Tambah Produk</a>
                                <!--end::Add product-->
                            </div>
                            <!--end::Toolbar-->
                        </div>
                                        ...
                                        @forelse ($pagar as $key => $pagar)
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="symbol symbol-100px">
                                                            <span class="symbol-label"
                                                                style="background-image:url({{ asset('Images/uploads/pagar') }}/{{ $pagar->foto }});"></span>
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                        <div class="ms-5">
                                                            <!--begin::Title-->
                                                            <a href="/admin/pagar/{{ $pagar->id }}/edit"
                                                                class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                                data-kt-ecommerce-product-filter="product_name">{{ $pagar->judul }}</a>
                                                            <!--end::Title-->
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="text-center pe-0">
                                                    <span class="fw-bold ms-3">{{ $pagar->id }}</span>
                                                </td>
                                                <!--begin::SKU=-->
                                                <td class="text-center pe-0">
                                                    <span class="fw-bold">{{ $pagar->bahan }}</span>
                                                </td>
                                                <!--end::SKU=-->
                                                <!--begin::Price=-->
                                                <td class="text-center pe-0">
                                                    <span class="fw-bold text-dark">Rp. {{ $pagar->harga }}</span>
                                                </td>
                                                <!--end::Price=-->
                                                <!--begin::Status=-->
                                                <td class="text-center pe-0" data-order="Published">
                                                    <!--begin::Badges-->
                                                    @if ($pagar->status == 'tersedia')
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex flex-row justify-content-end">
                                                        <div class="p-2"><a href="/admin/pagar/{{ $pagar->id }}/edit"
                                                            class="btn btn-success btn-lg">Edit</a></div>
                                                        <div class="p-2"><a onclick="deleteConfirmation({{ $pagar->id }})"
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a onclick="deleteConfirmation({{ $pagar->id }})"
