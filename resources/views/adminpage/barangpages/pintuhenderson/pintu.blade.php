                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <!--begin::Menu-->
                                <a href="/admin/pintuhenderson/create"
                                        ...
                                        @forelse ($postpintu as $key => $postpintukasanyamuk)
                                            <tr>
                                                <td class="text-start">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-45px me-5">
                                                            <img alt="Pic"
                                                                src="{{ asset('Images/uploads/pintuhenderson') }}/{{ $postpintukasanyamuk->foto }}" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="/admin/pintuhenderson/{{ $postpintukasanyamuk->id }}/edit"
                                                        class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1">
