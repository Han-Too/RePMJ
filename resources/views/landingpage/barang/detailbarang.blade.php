                ...
                <div class="row d-flex flex-row align-items-start">
                            ...
                            <div id="carouselExample" class="carousel slide" style="position: relative">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="img-fluid" src="{{ asset('landing/img/barang/henderson.jpg') }}"
                                            alt="">
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="portfolio_right_text ">
                            <div class="text-dark">
                                <div class="mb-3 fs-4">Canopy Policarbonate Minimalis</div>

                                <div class="fs-2 ms-3 mb-3 fw-bold">Rp.100.000</div>
                            </div>
                            <div class="text-dark">
                                <div class="d-flex flex-row mb-1">
                                    <div class="p-2">Bahan</div>
                                    <div class="p-2">:</div>
                                    <div class="p-2">Besi Asli</div>
                                </div>
                                <div class="d-flex flex-row mb-1">
                                ...
                                <div class="d-flex flex-row mb-1">
                                    ...
                                    <div class="d-grid gap-2 mx-auto mt-5">
                                        <a href="https://wa.link/gxxpuy" class="btn btn-success btn-block py-3" style="border-radius: 5px">Beli
                                            Sekarang</a>
                                    </div>
