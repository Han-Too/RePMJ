                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('buykanopi') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" class="form-control" name="harga" value="{{ $kanopi->harga }}">
                            <input type="hidden" class="form-control" name="bahan" value="{{ $kanopi->bahan }}">
                            <input type="hidden" class="form-control" name="nama" value="{{ $kanopi->judul }}">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="row d-flex flex-row align-items-start">
                                ...
                                <div id="carouselExample" class="carousel slide" style="position: relative">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="img-fluid"
                                                src="{{ asset('Images/uploads/canopy') }}/{{ $kanopi->foto }}"
                                                alt="">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="portfolio_right_text ">
                                <div class="text-dark">
                                    <div class="mb-3 fs-4">{{ $kanopi->judul }}</div>
                                    <div class="fs-2 ms-3 mb-3 fw-bold">Rp. {{ $kanopi->harga }}
                                    </div>
                                </div>
                                <div class="text-dark">
                                    <div class="d-flex flex-row mb-1">
                                        ...
                                        <div class="p-2">:</div>
                                        <div class="p-2">{{ $kanopi->bahan }}</div>
                                    </div>
                                    <div class="d-flex flex-row mb-1">
