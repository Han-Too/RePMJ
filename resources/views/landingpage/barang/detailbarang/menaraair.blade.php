            ...
            <div class="modal-body">
                <form method="post" action="{{ route('buykanopi') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" class="form-control" name="harga" value="{{ $postmenaraair->harga }}">
                        <input type="hidden" class="form-control" name="bahan" value="{{ $postmenaraair->bahan }}">
                        <input type="hidden" class="form-control" name="nama" value="{{ $postmenaraair->judul }}">
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="modal_login" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('buymenaraair') }}">
                    @method('POST')
                    @csrf
                    <div class="mb-3">
                        <label for="user" class="col-form-label">User :</label>
                    ...
                    <div class="row d-flex flex-row align-items-start">
                        ...
                        <div class="col-md-6">
                            <div class="portfolio_right_text ">
                                <div class="text-dark">
                                    <div class="mb-3 fs-4">{{ $postmenaraair->judul }}</div>
                                    <div class="fs-2 ms-3 mb-3 fw-bold">Rp. {{ $postmenaraair->harga }}
                                    </div>
                                </div>
                                <div class="text-dark">
                                    <div class="d-flex flex-row mb-1">
                                        ...
                                        <div class="p-2">:</div>
                                        <div class="p-2">{{ $postmenaraair->bahan }}</div>
                                    </div>
                                    <div class="d-flex flex-row mb-1">
                            ...
                            <table class="ms-3 text-dark">
                                <tbody>
                                    ...
                                    <tr style="line-height: 40px">
                                        <td>Jenis Produk</td>
                                        <td> : </td>
                                        <td>{{ $postmenaraair->jenis_produk }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
