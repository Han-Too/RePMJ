            ...
            <div class="modal-body">
                <form method="post" action="{{ route('buykanopi') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" class="form-control" name="harga" value="{{ $pagar->harga }}">
                        <input type="hidden" class="form-control" name="bahan" value="{{ $pagar->bahan }}">
                        <input type="hidden" class="form-control" name="nama" value="{{ $pagar->judul }}">
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="modal_login" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('buypagar') }}">
                    @method('POST')
                    @csrf
                    <div class="mb-3">
                        <label for="user" class="col-form-label">User :</label>
