            ...
            <div class="modal-body">
                <form method="post" action="{{ route('buykanopi') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="hidden" class="form-control" name="harga" value="{{ $railingtangga->harga }}">
                        <input type="hidden" class="form-control" name="bahan" value="{{ $railingtangga->bahan }}">
                        <input type="hidden" class="form-control" name="nama" value="{{ $railingtangga->judul }}">
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="modal_login" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('buyrailingtangga') }}">
                    @method('POST')
                    @csrf
                    <div class="mb-3">
                        <label for="user" class="col-form-label">User :</label>
                    ...
                    <div class="row d-flex flex-row align-items-start">
                                ...
                                <div id="carouselExample" class="carousel slide" style="position: relative">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="img-fluid"
                                                src="{{ asset('Images/uploads/railingtangga') }}/{{ $railingtangga->foto }}"
                                                alt="">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="portfolio_right_text ">
                                <div class="text-dark">
                                    <div class="mb-3 fs-4">{{ $railingtangga->judul }}</div>
                                    <div class="fs-2 ms-3 mb-3 fw-bold">Rp. {{ $railingtangga->harga }}
                                    </div>
                                </div>
                                <div class="text-dark">
                                    <div class="d-flex flex-row mb-1">
                                        ...
                                        <div class="p-2">:</div>
                                        <div class="p-2">{{ $railingtangga->bahan }}</div>
                                    </div>
                                    <div class="d-flex flex-row mb-1">
                            ...
                            <table class="ms-3 text-dark">
                                <tbody>
                                    ...
                                    <tr style="line-height: 40px">
                                        <td>Jenis Produk</td>
                                        <td> : </td>
                                        <td>{{ $railingtangga->jenis_produk }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
